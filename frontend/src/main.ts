...
import { ApiClient, SessionInfo } from "./api.js";
import { openTerminalSession, TerminalSession, SessionStatus } from "./terminal.js";
...
function getOrPromptUserId(): string {
...
function updateToolbar(session: SessionInfo | undefined, status?: SessionStatus) {
        if (!session) {
